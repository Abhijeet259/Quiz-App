...
const redirect = () => {
    let get = document.getElementById("next3");
    ...
    if(score<=5){
        ...
        localStorage.setItem("gamelevel4",'../level4/level4.html');
...
let loadQuestion = () => {
    ...
    if (z < 9) {
        ...
        <form id="next"><button class = 'btn' onclick = "redirect()">${(score <= 5) ? "try again" : "Passed"}</button></form>`;
